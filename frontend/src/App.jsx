...
function App() {
  ...
  const handleDiagnose = async () => {
    ...
    setSavedId(null);
    try {
      const response = await axios.post(`${API_BASE}/diagnose`, { query, top_k: topK });
  ...
  const handleSaveIncident = async (payload) => {
    const resp = await axios.post(`${API_BASE}/save-incident`, payload);
